...
//  Description: TextRenderer implementation
...
TextRenderer::TextRenderer(GLuint width, GLuint height)
{
	...
	this->TextShader = ResourceManager::LoadShader("assets/shaders/text.vert", "assets/shaders/text.frag", nullptr, "text");
...
/*
* Function - Load(@param)
* Loads specified font with font size
* Author:   Alex (Valeriy) Ruzhitskiy
* @param :
* std::string font - font path
* GLuint fontSize - font size
*/
...
* GLfloat x - x position on screen
* GLfloat y - y position on screen
