...
//  Description: SpriteRenderer system implementation
...
* Author:   Alex (Valeriy) Ruzhitskiy
* @param :
* Shader shader - reference to the shader to use for rendering
*/
...
* glm::vec2 size - psrite size
* GLfloat rotate - sprite rotation
