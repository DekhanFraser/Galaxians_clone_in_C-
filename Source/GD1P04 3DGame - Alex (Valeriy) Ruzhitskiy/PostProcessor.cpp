...
//
//  File Name : PostProcessor.cpp
//  Description: Postprocessor implementation
...
* Author - Alex (Valeriy) Ruzhitskiy
* @param :
* Shader shader - shader object to render with
...
* Start buffering rendered data to backbuffer
* Author - Alex (Valeriy) Ruzhitskiy
*/
...
/*
* Function - EndRender()
* End buffering rendered data to backbuffer
* Author - Alex (Valeriy) Ruzhitskiy
*/
